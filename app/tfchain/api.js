...
export var Account =  __class__ ('Account', [object], {
	...
	get deserialize () {return __getcm__ (this, function (cls, account_name, password, data) {
		...
		var account = cls (account_name, password, __kwargtrans__ ({seed: jsencode.hex_to_buffer (data.data.seed)}));
	...
	get serialize () {return __get__ (this, function (self) {
		...
		return dict ({'account_name': self._account_name, 'password': self._password, 'data': dict ({'seed': jsencode.buffer_to_hex (self._seed), 'wallets': (function () {
			var __accu0__ = [];
			for (var wallet of self._wallets) {
