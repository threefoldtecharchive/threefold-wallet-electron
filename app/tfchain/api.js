...
import * as __module_tfchain_types_FulfillmentTypes__ from './tfchain.types.FulfillmentTypes.js';
__nest__ (tfchain, 'types.FulfillmentTypes', __module_tfchain_types_FulfillmentTypes__);
import * as __module_tfchain_types_CryptoTypes__ from './tfchain.types.CryptoTypes.js';
__nest__ (tfchain, 'types.CryptoTypes', __module_tfchain_types_CryptoTypes__);
