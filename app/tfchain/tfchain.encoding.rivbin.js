...
export var IntegerOutOfRange =  __class__ ('IntegerOutOfRange', [Exception], {
	__module__: __name__,
});
export var SliceLengthOutOfRange =  __class__ ('SliceLengthOutOfRange', [Exception], {
	__module__: __name__,
});
...
export var RivineBinaryEncoder =  __class__ ('RivineBinaryEncoder', [object], {
	...
	get _check_int_type () {return __get__ (this, function (self, value, limit) {
		...
		if (value < 0) {
			var __except0__ = IntegerOutOfRange ('integer {} is out of lower range of 0'.format (value));
			__except0__.__cause__ = null;
			throw __except0__;
		}
		if (value > limit) {
			var __except0__ = IntegerOutOfRange ('integer {} is out of upper range of {}'.format (value, limit));
			__except0__.__cause__ = null;
			throw __except0__;
		}
	});},
	...
	get _add_slice_length () {return __get__ (this, function (self, length) {
		...
		if (length < pow (2, 7)) {
			...
			var __except0__ = SliceLengthOutOfRange ('slice length {} is out of range'.format (length));
			__except0__.__cause__ = null;
			throw __except0__;
		}
	});},
