...
b2b.blake2b = {
  ...
  blake2bCompress: function(ctx, last) {
    ...
    // b2b.util.debugPrint('          this.m[16]', this.m, 64)
    for (i = 0; i < 12; i++) {
      // b2b.util.debugPrint('   (i=' + (i < 10 ? ' ' : '') + i + ') v[16]', v, 64)
    ...
    // b2b.util.debugPrint('   (i=12) v[16]', v, 64)

    for (i = 0; i < 16; i++) {
      ctx.h[i] = ctx.h[i] ^ this.v[i] ^ this.v[i + 16]
    }
    // b2b.util.debugPrint('h[8]', ctx.h, 64)
  },
  ...
  blake2b: function(input, key, outlen) {
    // preprocess inputs
    outlen = outlen || 64
    input = b2b.util.normalizeInput(input)
...
export var blake2b = function (input) {
	...
	var output = null;
	  ...
	  output = b2b.blake2b.blake2b(input, null, 32);
...
export var blake2b_hex = function (input) {
	...
	var output = null;
	  ...
	  output = b2b.blake2b.blake2bHex(input, null, 32);
