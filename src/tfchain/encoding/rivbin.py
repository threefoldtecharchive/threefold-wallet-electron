...
class RivineBinaryEncoder:
    ...
    def add_int8(self,value):
        ...
        self._data = jsarray.concat(self._data, jsencode.int8_to_little_bytes(value))
    ...
    def add_int16(self,value):
        ...
        self._data = jsarray.concat(self._data, jsencode.int16_to_little_bytes(value))
    ...
    def add_int24(self,value):
        ...
        self._data = jsarray.concat(self._data, jsencode.int24_to_little_bytes(value))
    ...
    def add_int32(self,value):
        ...
        self._data = jsarray.concat(self._data, jsencode.int32_to_little_bytes(value))
    ...
    def add_int64(self,value):
        ...
        self._data = jsarray.concat(self._data, jsencode.int64_to_little_bytes(value))
    ...
    def add_array(self,value):
        ...
        if isinstance(value, str):
            self._data = jsarray.concat(self._data, jsencode.str_to_utf8(value))
    ...
    def add_byte(self, value):
        ...
        if isinstance(value, int):
            ...
            if isinstance(value, str):
                value = jsencode.str_to_utf8(value)
