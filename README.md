...
A desktop application that allows you to manage all your Threefold wallets. We support four types of tokens, Threefold token (TFT), Goldchain token (GFT), Free Flow token (FFT) and Threefold Bonus token (TFB). Each wallet is linked to an account, and an account is identified by a seed (mnemonic phrase). An account can have multiple wallets. Each wallet can have up to `8` addresses and requires a minimum `1` address (the default).
...
- [Windows Installer](https://github.com/threefoldtech/threefold-wallet-electron/releases/download/v0.5.1/Threefold-Wallet.Setup.0.5.1.exe)
  - Windows 7 or later
  - ia32 (x86) and x64 (amd64)
- [macOS Installer](https://github.com/threefoldtech/threefold-wallet-electron/releases/download/v0.5.1/Threefold-Wallet-0.5.1.dmg)
  - 10.10 (Yosemite) or later
  - 64-bit only
- [Linux Installer](https://github.com/threefoldtech/threefold-wallet-electron/releases/download/v0.5.1/Threefold-Wallet.0.5.1.AppImage)
